...
import com.InnovativePractice.service.IUserService;
...
//实现登录
    ...
    public String chatString( String question) throws IOException {
        System.out.println("Received SSE request with question: " + question);
        Map<String, Object> map = ThreadLocalUtil.get();
        int UserId=(int) map.get("userId");
        String res=userService.chat(UserId,question);
        return res;
    }
