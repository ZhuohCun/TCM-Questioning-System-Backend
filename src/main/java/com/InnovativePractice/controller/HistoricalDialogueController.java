...
import com.InnovativePractice.service.IHistoricalDialogueService;
...
public class HistoricalDialogueController {
    @Autowired
    private IHistoricalDialogueService historicalDialogueService;
    ...
    @GetMapping("/getList")
    public RespondMessage getList(
            @RequestHeader(name = "Authorization") String token,
            @RequestParam @Min(1) Integer pageId,
    ...
    )
    {
        ...
        List<Map<String, Object>> list = historicalDialogueService.getList(userId, pageId, count);
